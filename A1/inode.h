...
public:
    ...
    void set_cwd(const wordvec pathname, const bool b);
    void add_directory(const wordvec pathname, const bool b);
    void add_file(const wordvec& data, const wordvec& pathname, bool b);
    void remove(const wordvec pathname, bool b, bool x);
    string readfile(const wordvec pathname, bool b);
...
public:
    ...
    size_t size();
    const map<string,inode_ptr>& get_contents();
    void writefile(const wordvec& d);
...
public:
    ...
    void set_parent(inode_ptr inptr);
    void set_dot(inode_ptr inptr);
